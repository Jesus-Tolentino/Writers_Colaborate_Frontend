...
@Component({
  ...
  standalone: false,
  templateUrl: './author-register.html',
  styleUrl: './author-register.css',
})
  ...
  ngOnInit(){
    ...
    CargarFormulario() {
      ...
      this.crudForm = this.formBuilder.group(
        {
          id:[" "],
          name:[nameuser,[Validators.required, Validators.minLength(2)]],
          ...
          if (author.id>0) {
            this.authorService.update(author).subscribe({
              ...
              next:(data:Author)=>{
                ...
                this.snack.open("Se registró con éxito y se asignó el Id "+data.id.toString(),"OK",{duration:2000});
                this.router.navigate(["/home"]);
              },
                  error: (http_error)=>{
                          this.snack.open("ERROR: No fue posible el registro. "+http_error.error.message,"OK",{duration:5000});
                          console.log(http_error);
              }  
            })
          }
